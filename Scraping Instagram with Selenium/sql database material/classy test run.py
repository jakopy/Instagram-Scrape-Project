...
class database():
    ...
    def create(self):
        ...
        #insert here
        ins = users.insert()
        ins.values(profilename='blahblahblahblahblah')
        ins.compile().params
        conn = engine.connect()
...
path = "sqlite:///C:\Users\Jacob\Documents\uber project\Website Scraping\Jacob's Instacrawler\userinputcrawlapp\classy input crawler\testy.db"
base = database(path)
base.create
usernames = True
